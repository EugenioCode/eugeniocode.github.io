    ...
    <div class="site-footer">
        <div class="btmgroup">
            <div class="msgcard">
                ...
                <div class="copyright" style="font-family: sans-serif;" v-if="website?.showFooter">
                    Copyright © {{ new Date().getFullYear() === 2022 ? '' : '2022-' }}{{ new Date().getFullYear() }} <a
                        class="title strong" :href="website?.link">{{ webTitle }}</a>
                        <!-- <p class="source">由<a class="strong" href="https://vitepress.dev/" target="_blank">vitepress</a>构建</p> -->
